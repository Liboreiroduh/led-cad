...
class ProjectStore:
    ...
    def _persist(self) -> None:
        """Salva a sessão atual (best-effort) para sobreviver a reload do
        servidor (uvicorn --reload) — o usuário não perde o projeto aberto."""
        ...
        try:
            ...
            pass  # persistência de sessão nunca derruba a API
