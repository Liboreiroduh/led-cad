(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={cube:`<path d="m12 3 9 5v8l-9 5-9-5V8l9-5Z"/><path d="m3 8 9 5 9-5M12 13v8M7.5 5.5l9 5"/>`,front:`<rect x="5" y="3" width="14" height="15" rx="1"/><path d="M12 18v3M9 21h6M5 8h14M10 3v15"/>`,side:`<path d="m8 4 9-2v16l-9 2V4ZM12 19v3M9 22h6"/>`,top:`<path d="m4 5 8 15 8-15M4 5h16"/><path d="M12 20V9" stroke-dasharray="2 3"/>`,reset:`<path d="M3 10a9 9 0 1 1 2.7 8.4M3 4v6h6"/>`,ruler:`<path d="m3 16 13-13 5 5L8 21l-5-5ZM7 12l2 2M10 9l2 2M13 6l2 2M4 15l2 2"/>`,explode:`<path d="m12 3 8 4-8 4-8-4 8-4ZM4 12l8 4 8-4M4 17l8 4 8-4"/>`,plus:`<path d="M12 5v14M5 12h14"/>`,minus:`<path d="M5 12h14"/>`,expand:`<path d="M8 3H3v5M16 3h5v5M3 16v5h5M21 16v5h-5"/>`,pointer:`<path d="m5 3 14 9-7 1-3 7-4-17Z"/>`,arrow:`<path d="M5 12h14m-5-5 5 5-5 5"/>`,chevron:`<path d="m6 9 6 6 6-6"/>`,info:`<circle cx="12" cy="12" r="9"/><path d="M12 11v6M12 7v.1"/>`,warning:`<path d="m12 3 10 18H2L12 3ZM12 9v5M12 17v.1"/>`},t=(t,n=``)=>`<svg class="icon ${n}" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.55" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${e[t]||e.cube}</svg>`,n=Object.freeze({faceWidth:2880,faceHeight:3840,cabinetWidth:960,cabinetHeight:960,columns:3,rows:4,rearOpening:2e3,freeHeight:2500,postDiameter:150,baseDiameter:600,baseThickness:25,anchorOffset:150,visual:Object.freeze({postZ:350,cabinetDepth:100,cabinetGap:4,ledInset:7,ledDepth:2,profileSize:50,frameDepth:55,rearBracketSize:36,braceSize:30,spineSize:70,anchorDiameter:24,anchorHeight:70,washerDiameter:48,washerThickness:5,nutDiameter:38,nutHeight:20,explodedFaceOffset:450,explodedFaceLift:120,explodedFrameLift:200,explodedFrameOffset:100,explodedPostLift:300,explodedBaseOffset:300})}),r=e=>e/1e3,i=n.rearOpening/2,a=Object.freeze({depth:Math.sqrt(n.faceWidth**2-i**2),halfAngle:Math.asin(i/n.faceWidth),angle:2*Math.asin(i/n.faceWidth),totalHeight:n.freeHeight+n.faceHeight});function o(){let e=82/a.depth,t=n.rearOpening/2*e,r=130-t,i=130+t,o=90-a.halfAngle*180/Math.PI;return`<svg class="plan-diagram" viewBox="0 0 260 125" role="img" aria-label="Vértice frontal, duas faces de ${n.faceWidth} milímetros, abertura traseira de ${n.rearOpening} milímetros">
    <path d="M${r} 27 130 109 ${i} 27" fill="#e9eedf" stroke="#6a7856" stroke-width="3" stroke-linejoin="round"/>
    <path d="M${r} 15H${i}M${r} 10v13M${i} 10v13M130 29v65" stroke="#9ba78d" stroke-width="1" stroke-dasharray="2 2"/>
    <circle cx="130" cy="109" r="3.5" fill="#596845"/>
    <text x="130" y="10" text-anchor="middle">${n.rearOpening.toLocaleString(`pt-BR`)}</text>
    <text x="${r+3}" y="77" transform="rotate(${-o} ${r+3} 77)">${n.faceWidth.toLocaleString(`pt-BR`)}</text>
    <text x="${i+4}" y="57" transform="rotate(${o} ${i+4} 57)">${n.faceWidth.toLocaleString(`pt-BR`)}</text>
    <text x="130" y="64" text-anchor="middle">${(a.angle*180/Math.PI).toLocaleString(`pt-BR`,{maximumFractionDigits:2})}°</text>
    <text x="130" y="124" text-anchor="middle">FRENTE</text>
  </svg>`}function s(e){let r=e=>new Intl.NumberFormat(`pt-BR`,{maximumFractionDigits:0}).format(e),i=(e,t)=>`<div class="spec-row"><dt>${e}</dt><dd>${t}</dd></div>`;e.innerHTML=`
    <header class="site-header">
      <a class="brand" href="./" aria-label="LED COLLOR, início"><span class="brand-symbol">${t(`cube`)}</span><span>LED<span class="brand-light">COLLOR</span><small>SOLUÇÕES EM LED</small></span></a>
    ...
    <main>
      <section class="project-heading" aria-labelledby="project-title">
        ...
        <div class="heading-meta"><span>DIMENSÃO POR FACE</span><strong>${r(n.faceWidth)} <i>×</i> ${r(n.faceHeight)} <small>mm</small></strong></div>
      </section>
      <section class="workspace" aria-label="Apresentação interativa do painel LED">
        <div class="viewer-column">
          <nav class="view-toolbar" aria-label="Vistas do modelo"><div class="view-buttons">
            ${[[`perspective`,`cube`,`Perspectiva`],[`front`,`front`,`Frontal`],[`side`,`side`,`Lateral`],[`top`,`top`,`Superior`]].map(([e,n,r])=>`<button class="view-button ${e===`perspective`?`is-active`:``}" data-view="${e}" aria-pressed="${e===`perspective`}">${t(n)}<span>${r}</span></button>`).join(``)}
          </div><button class="reset-button" id="reset" title="Restaurar vista e configurações" aria-label="Reset — restaurar visualização">${t(`reset`)}<span>Reset</span></button></nav>
          <div class="viewport" id="viewport" aria-label="Modelo 3D interativo">
            ...
            <div class="viewport-tools" aria-label="Zoom e tela cheia"><button id="zoom-in" title="Aproximar" aria-label="Aproximar">${t(`plus`)}</button><button id="zoom-out" title="Afastar" aria-label="Afastar">${t(`minus`)}</button><span></span><button id="fullscreen" title="Tela cheia" aria-label="Tela cheia" aria-pressed="false">${t(`expand`)}</button></div>
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Wo(e,t,n){return new ia({name:`SphericalGaussianBlur`,defines:{SAMPLES:ko,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:qo(),fragmentShader:`
	...
	`}var Jo=class extends tn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ii(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
